...
class getIndexControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.em9lYbP'] ?? $container->load('get_ServiceLocator_Em9lYbPService'))->withContext('App\\Engine\\Controller\\IndexController', $container));
